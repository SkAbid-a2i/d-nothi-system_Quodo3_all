...
const AgentDashboard = () => {
  ...
  // Filter tasks based on search term and advanced filters
  const filteredTasks = tasks.filter(task => {
    ...
    if (filterMode === 'or') {
      ...
      return matchesSearch && matchesRole && matchesSource && matchesCategory && matchesSubCategory && matchesIncident && matchesOffice && matchesUser && matchesUserInformation && matchesObligation;
    }
  });
